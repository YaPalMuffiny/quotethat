...
module.exports = class testHandler extends handler {
     ...
     */
	constructor(heart) {
		super(heart, 'quotethat');
		heart.core.discord.core.cache.manager.register(new heart.core.discord.core.cache.interface(heart, 'quoteCache'));
	}

	getCache() {
		return this.heart.core.discord.core.cache.manager.get('quoteCache');
	}
};